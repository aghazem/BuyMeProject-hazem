...
public class SiteTesting {
    ...
    private final String firstName = "Hazem";
    ...
    private void initializeSite() {
        ...
        extentReports.setSystemInfo("Tester","Hazem Agbariya.");
    ...
    public void testIntroPage(){
        try {
            ...
            String email = "ag.hazem777@gmail.com";
    ...
    public void payAndSendGift(){
        String recipientEmail = "ag.hazem777@gmail.com";
        extentTest.info("Pay and send gift");
        try {
            MoneyPage moneyPage = new MoneyPage();
            moneyPage.fillForm_SendToWho(PresentReceiver.OTHER,"חאזם",3,"nice pic","images/HazemPic.jpg");
